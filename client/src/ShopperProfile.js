  ...
  return (
    <main className="container">
      <div class="row">
          ...
          <a href="https://placeholder.com"><img class="rounded-circle profile" src="https://via.placeholder.com/150"/></a>
          <p>Name</p>
          <p>Friends</p>
          ...
          <div class="col-md-7 offset-md-1" id="list-view">
              ...
              <div class="row g-0">
                  ...
                  <div class="card-body">
                      ...
                      <p class="card-text">Short Description of Shop Type.</p>
                      <div class="row">
                        <div class="col-md-1">
                  ...
                  <a href="#" class="btn btn-primary">button to view profile page</a>
                  <div class="col-md-1">
                  ...
                  <div class="col-md-7">
                      <p>Name @username “Excerpt of shoutout...”</p>
                  </div>
                  </div>
              </div>
