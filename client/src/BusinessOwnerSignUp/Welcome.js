...
function Welcome() {
    ...
    return (
        <main className="container">
            <h1>Welcome to SmolBiz! Let's set up your business!</h1>
            <form onSubmit={onSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input className="form-control" type="text" name="modelName" value={shoptype.modelName} onChange={onChangeShopType} />
                </div>
                <div className="mb-3">
